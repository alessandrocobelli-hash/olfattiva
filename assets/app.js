...
(function () {
  ...
  function onInput(el) { var k = el.dataset.input; if (k === 'catQuery') { var c = UI.cat = UI.cat || { q: '', fam: '', lon: false, sort: 'fit', n: 150 }; c.q = el.value; c.n = 150; } else UI[k] = el.value; render(INPUTS[k]); }

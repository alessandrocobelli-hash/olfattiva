...
var VERSION = 'efa4ae597d';
var CACHE = 'olfattiva-' + VERSION;
var SHELL = ["assets/app.css?v=efa4ae597d", "assets/app.js?v=efa4ae597d", "assets/core.js?v=efa4ae597d", "assets/engine.js?v=efa4ae597d", "assets/fonts/bodoni-moda-latin-400-italic.woff2", "assets/fonts/bodoni-moda-latin-400-normal.woff2", "assets/fonts/dm-mono-latin-400-normal.woff2", "assets/fonts/dm-mono-latin-500-normal.woff2", "assets/fonts/instrument-sans-latin-400-normal.woff2", "assets/fonts/instrument-sans-latin-500-normal.woff2", "assets/fonts/instrument-sans-latin-600-normal.woff2", "assets/icons/apple-touch-icon.png", "assets/icons/favicon-32.png", "assets/icons/icon-192.png", "assets/icons/icon-512.png", "assets/icons/icon-maskable-512.png", "assets/rea.jpg", "assets/views-a.js?v=efa4ae597d", "assets/views-b.js?v=efa4ae597d", "assets/views-c.js?v=efa4ae597d", "index.html", "manifest.webmanifest"];
...
self.addEventListener('fetch', function (e) {
  ...
  e.respondWith(caches.match(e.request).then(function (hit) { return hit || fetch(e.request).then(function (r) { if (r.ok) { var cp = r.clone(); caches.open(CACHE).then(function (c) { c.put(e.request, cp); }); } return r; }).catch(function () { return e.request.mode === 'navigate' ? caches.match('./') : Response.error(); }); }));
});
